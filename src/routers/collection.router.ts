...
router.post('/in-user', roleRequire(),permanentBan(), colleciontController.addInUser);
router.post('/in-artist', roleRequire(),permanentBan(), colleciontController.addInArtist);
